...
class Validaciones{
    ...
    public:
        ...
        int pedirValorInicial(){
            int numero;
            cout<<"Ingrese el valor inicial del 1 al 100: ";
            numero = ingresarEnteros();
            cout<<endl;
            do{
	            if(numero >100){
	            	cout<<"Ingrese un valor inicial dentro del rango estipulado: "<<endl;
	                system("PAUSE");
	                system("CLS");
	                return pedirValorInicial();
				}
			}while(numero>100);
            return numero;
        }
        ...
        int pedirProgresionAritmetica(){
            ...
            do{
	            if(numero >100){
	                ...
	                system("PAUSE");
	                system("CLS");
	                return pedirProgresionAritmetica();
				}
			}while(numero>100);
            return numero;
        }
